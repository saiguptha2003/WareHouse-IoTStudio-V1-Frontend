...
const Sidebar: React.FC = () => {
  ...
  const fetchSections = async () => {
    try {
      const response = await fetch("http://localhost:5000/services/WareHouse/CustomizedSection", {
        method: "GET",
  ...
  const handleCreateSection = async () => {
    ...
    try {
      const response = await fetch("http://localhost:5000/services/WareHouse/createCustomizedSection", { 
        method: "POST",
        headers: {
